...
const EventsCard = ({ event }) => {
  ...
  return (
    <div className="bg-base-100 rounded-t-xl rounded-b-3xl shadow-md overflow-hidden  border border-base-300 hover:scale-105 transition-transform duration-300">
